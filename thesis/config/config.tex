...
\newcommand{\thesisTitleEng}{Detecting SQL Antipatterns in jOOQ Database Access Code Using Large Language Models} % variable with thesis title
\newcommand{\thesisTitleEst}{SQL antimustrite tuvastamine jOOQ andmebaasikoodis suurte keelemudelite abil} % Title in Estonian

% Choose your thesis
\newcommand{\thesisType}{Master's Thesis}

% Thesis author
\newcommand{\authorName}{Kristo Isberg}
\newcommand{\studentcode}{214012IVSM}
...
% Main supervisor
\newcommand{\supervisorName}{Erki Eessaar}
...
\newcommand{\keywords}{master's theses, SQL, antipatterns, jOOQ, language models, static analysis, prompting, Java}
