...
A \num{10000}-replicate project-cluster bootstrap gave percentile ranges of \num{0.798}--\num{0.931} for micro precision, \num{0.820}--\num{0.913} for micro recall, and \num{0.820}--\num{0.912} for micro F1. These are conditional project-composition sensitivity ranges for this selected split, not population confidence intervals. Several classes occur in few held-out projects, so class-level resamples are unstable and are not used for inference.
