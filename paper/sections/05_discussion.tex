...
RQ3 codes source-fragment patterns for two of the seven detector-flag classes. Future work could extend this coding to the other five classes and resolve call targets before analysing API associations. The \num{15931} corpus flags could also guide independently evaluated deterministic detection rules.
