...
In jOOQ, the blind projection described above can be expressed through chained \texttt{select()} and \texttt{from(TABLE)} calls. Online Resource~1 provides the paired SQL and jOOQ listings.
