...
An antipattern is a recurring ineffective solution with negative long-term consequences \citetext{\citealp[p. 46]{koenig1995patterns}; \citealp[p. 4]{ambler1998process}; \citealp[p. 6]{brown1998antipatterns}}. A code smell is a source-code characteristic that signals a poor practice and may warrant inspection \nobreakcite[pp. 71--72]{fowler2019refactoring}.
