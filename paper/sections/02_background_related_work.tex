...
Prior LLM studies analyse source directly. Their reported output units also differ from the present task. Code-quality studies report recognition or classification of problematic code \nobreakcite{blaauwendraad2025evaluating}. PL/SQL work reports smell detection over procedural SQL source \nobreakcite[p. 410]{de2025effectiveness}. The present detector receives Java DSL and generated-schema code and can return several class-labelled line spans from one file. Table~\ref{tab:detectionApproaches} compares these representations and output units. Prior approaches report recovered-SQL, query-log, or matched-node warnings; this study reports multiple class-labelled spans from Java DSL and generated-schema code.
...
\begin{longtable}{@{}>{\raggedright\arraybackslash}p{0.20\textwidth}>{\raggedright\arraybackslash}p{0.34\textwidth}>{\raggedright\arraybackslash}p{0.36\textwidth}@{}}
    ...
    Does not directly localise source occurrences represented by jOOQ DSL calls or generated schema classes. \\
