...
\begin{itemize}
    ...
    \item \textbf{RQ2:} How frequently does the selected detector flag each of the seven SQL antipatterns in the 602-repository corpus, and how are those flags distributed across eligible files and repositories?
...
\begin{itemize}
    ...
    \item a file-normalised characterisation of detector flags in 602 identified repositories, separating flagged-file breadth from within-file repetition and testing repository-size and exact-content sensitivity, together with recurring source-fragment patterns for two flag classes.
\end{itemize}
