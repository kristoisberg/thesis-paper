...
The corpus measures use role-eligible files, a broader denominator than class-specific API opportunities: an application/query file may contain no eligible projection or search predicate, and a generated-schema file may expose several database objects. They also retain detector errors observed in the held-out evaluation. The exploratory categories classify returned fragments without resolving call targets. Accordingly, the corpus results characterise detector-output density, breadth, repetition, and fragment composition. Estimating antipattern prevalence or API risk would require an independent audit with API-opportunity denominators.
