...
Relative to the 6,985-word restoration baseline, the current TeXCount increase is 3,138 words, inside the planned 2,850--3,150 range. The compiled main PDF contains 12,878 layout-extracted words across 32 A4 pages. The supplement contains 1,954 layout-extracted words across seven A4 pages.

The current article has two figures and nine labelled tables. Two tables use `longtable`, so TeXCount reports nine floats for 11 labelled visual elements.
...
The DOI-backed deposit and author-confirmed declaration blockers recorded in Step 13 are unchanged.
